    ...
    for directory in directorylist:
        ...
        for file in os.listdir(rootdirectory + "/" + directory):
            if fnmatch.fnmatch(file, '*' + filepattern + '*' + extension):
                ...
                #
                # Check whether file is already in list (appears with
                # multiple information layers (==preprocessing layers)
                #

                if fileinfo["filename"] not in filenames:
                    #
...
def extractMetadata(rootdirectory, sensortype, product, tile=None):
    ...
    if sensortype == "Sentinel-2":
        datasetTitle = "Bidi Bidi, Uganda"
        description = ("This Sentinel 2 tile contains an extremely quickly growing refugee camp.")
...
if __name__ == "__main__":
    ...
    if deleteCoverages == False:
        ...
        metadata = extractMetadata('/var/projects/aiq/rawdata/', "Sentinel-2", "SIAM_AIQ", tile="36NUJ")       
