    ...
    for folder in siam_folders:
        ...
        for layer in siam_layers:
            ...
            if layer.endswith('VegBinaryMask.dat'):
                band_in_stack = 6
            if layer.endswith('HazePentarnaryMask.dat'):
                band_in_stack = 5
            if layer.endswith('fRatioGreennessIndex.dat'):
                band_in_stack = 7
            if layer.endswith('cBrightness.dat'):
                band_in_stack = 8
            if layer.endswith('33SharedSpCt_r88v7.dat'):
                band_in_stack = 2
            if layer.endswith('18SpCt_r88v7.dat'):
                band_in_stack = 1
            if layer.endswith('48SpCt_r88v7.dat'):
                band_in_stack = 3
            if layer.endswith('96SpCt_r88v7.dat'):
                band_in_stack = 4
...
if __name__ == "__main__":
    ...
    root_folder = '/data/s2/37SBA/S2A_MSIL1C_20161212T082332_N0204_R121_T37SBA_20161212T082908.SAFE/'
    ...
    # Create class stack.
    #
    siam_classes = ['33SharedSpCt_r88v7.dat', '96SpCt_r88v7.dat', 'VegBinaryMask.dat', 'HazePentarnaryMask.dat', 'fRatioGreennessIndex.dat', 'cBrightness.dat', '48SpCt_r88v7.dat', '18SpCt_r88v7.dat']
