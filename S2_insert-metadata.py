...
def getFilemetadata(rootdirectory, directorylist, sensortype, product):
    ...
    if product == "SIAM 33 shared":
        filepattern = "33SharedSpCt"
    elif product == "CORINE":
...
def extractMetadata(rootdirectory,sensortype, product):
            ...
            "layers": [
                {
                    "acro":"CORINE",
                    "name": "CORINE classes",
                    "description": "These are the CORINE classes.",
                    "order": 0,
                    "belongs_to_collection": "CORINE_CLS"
                },
                {
                    "acro": "AREA",
                    "name": "area",
                    "description": None,
                    "order": 0,
                    "belongs_to_collection": "CORINE_SHP"
                },
                {
                    "acro": "CMPCTNESS",
                    "name": "compactness",
