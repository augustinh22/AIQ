...
def convert_imgs(root_folder, imgFolders):
    ...
    print ('Number of unprocessed IMG_DATA folders found: {}'.format(len(imgFolders)))
    ...
    for imgFolder in imgFolders:
        ...
        for namespace in XML_namespaces:
            ...
            try:
                ...
                message = ('{} in {} was parsed with {}.').format(
                    metadata_path[0], imgFolder, namespace)
        ...
        for band in tile_bands:
            ...
            if band.endswith(('_B02.jp2', '_B03.jp2', '_B04.jp2', '_B08.jp2',
                ...
                logger.info('Processing band #{}'.format(band_id))
...
if __name__ == '__main__':
    ...
    # Set-up logger.
    #
    log_dir = os.path.join(read_dir, 'log')
    if not os.path.exists(log_dir):
        os.mkdir(log_dir)

    logger_filepath = os.path.join(log_dir, 'stack_sentinel.log')
    ...
    logging.basicConfig(filename=logger_filepath,
                        ...
                        level=logging.DEBUG)
    logger = logging.getLogger('S2_stack')

    imgFolders_toProcess = check_imgFolders(read_dir)
    ...
    if imgFolders_toProcess == 0:
        ...
        convert_imgs(read_dir, imgFolders_toProcess)
